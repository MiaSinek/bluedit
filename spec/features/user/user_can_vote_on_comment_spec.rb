...
feature "User votes on comment" do
  ...
  scenario "with upvote twice unsuccessfully", js: true do
    upvote_link = find(:css, "a[href='#{upvote_submission_comment_path(@submission, @comment)}']")
    upvote_link.click
    upvote_link.click
  ...
  scenario "with downvote twice unsuccessfully", js: true do
    downvote_link = find(:css, "a[href='#{downvote_submission_comment_path(@submission, @comment)}']")
    downvote_link.click
    downvote_link.click
